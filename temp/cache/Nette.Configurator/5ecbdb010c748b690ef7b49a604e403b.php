<?php
// source: /var/www/users/archeryarena/newpage/brandnewpage/sandbox/app/config/config.neon 
// source: /var/www/users/archeryarena/newpage/brandnewpage/sandbox/app/config/config.local.neon 

/**
 * @property Nette\Application\Application $application
 * @property App\Model\MyAuthenticator $authenticator
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'app\\model\\myauthenticator' => array('authenticator'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/users/archeryarena/newpage/brandnewpage/sandbox/app',
			'wwwDir' => '/var/www/users/archeryarena/newpage/brandnewpage/sandbox/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/users/archeryarena/newpage/brandnewpage/sandbox/app/../temp',
		));
	}
	...
	/**
	 * @return App\Model\MyAuthenticator
	 */
	public function createServiceAuthenticator()
	{
		$service = new \App\Model\MyAuthenticator($this->getService('nette.database.default.context'));
		if (!$service instanceof App\Model\MyAuthenticator) {
			throw new Nette\UnexpectedValueException('Unable to create service \'authenticator\', value returned by factory is not App\\Model\\MyAuthenticator type.');
		}
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/users/archeryarena/newpage/brandnewpage/sandbox/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/users/archeryarena/newpage/brandnewpage/sandbox/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=localhost;dbname=archeryarena_main', 'archeryarena', 'crystal.waterfall', array('lazy' => TRUE));
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/var/www/users/archeryarena/newpage/brandnewpage/sandbox/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/users/archeryarena/newpage/brandnewpage/sandbox/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/users/archeryarena/newpage/brandnewpage/sandbox/app/../temp/cache', $this->getService('nette.cacheJournal'));
