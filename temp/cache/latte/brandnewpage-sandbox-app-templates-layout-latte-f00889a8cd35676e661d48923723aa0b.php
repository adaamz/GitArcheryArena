<?php
// source: /var/www/users/archeryarena/newpage/brandnewpage/sandbox/app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9712076214', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbd77543c241_head')) { function _lbd77543c241_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbb1eced1fac_scripts')) { function _lbb1eced1fac_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
